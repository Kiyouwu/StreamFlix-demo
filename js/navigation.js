            ...
            if (user) {
                ...
                headerActions.innerHTML = `
                    <div id="avatarContainer" class="avatar-container" style="display:flex; align-items:center; width:100%; justify-content:flex-end; gap:8px;">
                        <button class="icon-btn" id="headerMessageBtn" title="消息" onclick="window.location.href='message.html'" style="color:blue;"><div><p1><img src="assets/messageIcon.png", width="25px", height="25px"></p1></div><p2>消息</p2><span id="messageBadge" class="message-badge" style="display: none"; font-size:0.7em; margin-left:4px;"></span></button>
                        ...
                        <img src="${user.avatar || 'assets/default-avatar.png'}" alt="avatar" class="header-avatar" id="headerAvatar" onerror="this.onerror=null;this.src='assets/default-avatar.png'" />
