        ...
        if (user) {
            ...
            headerActions.innerHTML = `
                <div class="header-actions-inner" style="display:flex; align-items:center; gap:8px;">
                    ...
                    <button class="icon-btn" id="headerFavoritesBtn" title="收藏" onclick="window.location.href='profile.html?tab=favorites'" style="display: none"><div><p1><img src="assets/favoritesIcon.png", width="25px", height="25px"></p1></div><p2>收藏</p2></button>
                    ...
                    <img src="${user.avatar || 'assets/default-avatar.png'}" alt="avatar" class="header-avatar" id="headerAvatar" onclick="window.location.href='profile.html'" onerror="this.onerror=null;this.src='assets/default-avatar.png'" />
                </div>
            `;
        } else {
            headerActions.innerHTML = `
